...
import type { VerityWorkflow } from "../shared/types";
...
export function WorkflowList() {
    ...
    const { user } = useAuth();
    const [custom, setCustom] = useState<VerityWorkflow[]>([]);
    const [loading, setLoading] = useState(true);
    const [selected, setSelected] = useState<VerityWorkflow | null>(null);
    ...
    const [typeFilter, setTypeFilter] = useState<VerityWorkflow["type"] | null>(
        null,
    );
    ...
    const getTypeMeta = (type: VerityWorkflow["type"]) =>
        type === "tabular"
